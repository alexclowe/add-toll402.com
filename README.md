...
- [x402-mcp (Vercel)](https://github.com/AbanteAI/x402-mcp) — 3-line integration for monetizing MCP servers using the Vercel AI SDK and x402.
...
- [paid-mcp-starter](https://github.com/xpaysh/paid-mcp-starter) — Ready-to-use templates showing three monetization approaches: no-code (xpay✦), x402 protocol, and Stripe billing. Includes a sample MCP server.
...
This list is licensed under [Creative Commons Attribution 4.0 International](LICENSE).
